...
export default function Hero() {
  return (
   <div className="relative min-h-screen bg-gradient-to-t from-[#121b54] via-[#1b2a7f] to-[#2c3eb0] overflow-hidden">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80')] opacity-40 bg-cover bg-center" />
